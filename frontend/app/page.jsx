  ...
  return (
    <div className="min-h-screen" style={{
      ...
      <main className="px-4 py-6 pb-12 max-w-[430px] mx-auto">
        ...
        {/* Monthly Service */}
        <section className="mb-6">
          <h2 className="text-xl font-bold text-[#2A2725] mb-4 px-1">스피릿랩 월간 서비스</h2>
          ...
          <div className="space-y-3">
            {[
              ...
              {
                icon: '🔮',
                title: '맞춤형 상담 사주 기반 해석',
                desc: '1:1 상담을 통한 구조적 해석으로\n흐름을 이해하고 방향을 잡습니다',
              },
              {
                icon: '💬',
                title: '1:1 맞춤 피드백',
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-[rgba(191,167,255,0.15)] to-[rgba(123,203,255,0.15)] flex items-center justify-center">
        ...
        {/* Why You Need This */}
        <section className="mb-6">
          <h2 className="text-xl font-bold text-[#2A2725] mb-4 px-1">이러한 분들에게 좋습니다</h2>
        ...
        {/* When You Need Spirit Lab */}
        <section className="mb-6">
          <div className="bg-gradient-to-br from-[rgba(191,167,255,0.22)] via-[rgba(123,203,255,0.18)] to-[rgba(255,193,217,0.16)] bg-white/70 backdrop-blur-sm border border-[rgba(230,224,218,0.85)] rounded-[18px] p-5">
            <h3 className="text-lg font-bold text-[#2A2725] mb-2 text-center">
              당신이 이런 상태라면,
            </h3>
            <p className="text-sm text-[#6B6662] mb-4 text-center">
              스피릿랩이 필요한 시점입니다
            </p>
        ...
        <section className="mb-6">
          <div className="bg-gradient-to-br from-[rgba(191,167,255,0.22)] via-[rgba(123,203,255,0.18)] to-[rgba(255,193,217,0.16)] bg-white/70 backdrop-blur-sm border border-[rgba(230,224,218,0.85)] rounded-[18px] p-6 text-center">
            ...
            <button
              onClick={() => router.push('/hinewmemeber')}
